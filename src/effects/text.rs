    ...
    let font = [
        ...
        (
            ...
            vec![
                ...
                (Point::new(3., -1.), Point::new(5., -1.)),
                (Point::new(3., -2.), Point::new(5., -2.)),
                (Point::new(3., -3.), Point::new(5., -3.)),
                (Point::new(3., -4.), Point::new(5., -4.)),
                (Point::new(3., -5.), Point::new(5., -5.)),
                (Point::new(3., -6.), Point::new(5., -6.)),
                (Point::new(3., -7.), Point::new(5., -7.)),
                (Point::new(3., -8.), Point::new(5., -8.)),
                (Point::new(3., -9.), Point::new(5., -9.)),
            ],
        ),
        (
            'b',
            vec![
                (Point::new(0., 0.), Point::new(7., 0.)),
                (Point::new(0., -1.), Point::new(8., -1.)),
                (Point::new(0., -2.), Point::new(2., -2.)),
                (Point::new(7., -2.), Point::new(9., -2.)),
                (Point::new(0., -3.), Point::new(2., -3.)),
                (Point::new(7., -3.), Point::new(9., -3.)),
                (Point::new(0., -4.), Point::new(8., -4.)),
                (Point::new(0., -5.), Point::new(8., -5.)),
                (Point::new(0., -6.), Point::new(2., -6.)),
                (Point::new(7., -6.), Point::new(9., -6.)),
                (Point::new(0., -7.), Point::new(2., -7.)),
                (Point::new(7., -7.), Point::new(9., -7.)),
        ...
        (
            ...
            vec![
                ...
                (Point::new(7., -1.), Point::new(8., -1.)),
                (Point::new(1., -2.), Point::new(2., -2.)),
                (Point::new(7., -2.), Point::new(8., -2.)),
                (Point::new(1., -3.), Point::new(8., -3.)),
                (Point::new(3., -4.), Point::new(6., -4.)),
                (Point::new(4., -5.), Point::new(5., -5.)),
                (Point::new(4., -6.), Point::new(5., -6.)),
                (Point::new(4., -7.), Point::new(5., -7.)),
                (Point::new(4., -8.), Point::new(5., -8.)),
                (Point::new(4., -9.), Point::new(5., -9.)),
            ],
        ),
        (
            'p',
        ...
        (
            'w',
            vec![
                (Point::new(0., -9.), Point::new(1., -9.)),
                (Point::new(8., -9.), Point::new(9., -9.)),
                (Point::new(0., -8.), Point::new(2., -8.)),
                (Point::new(7., -8.), Point::new(9., -8.)),
                (Point::new(0., -7.), Point::new(3., -7.)),
                (Point::new(6., -7.), Point::new(9., -7.)),
                (Point::new(0., -6.), Point::new(9., -6.)),
                (Point::new(0., -5.), Point::new(9., -5.)),
                (Point::new(0., -4.), Point::new(2., -4.)),
                (Point::new(7., -4.), Point::new(9., -4.)),
                (Point::new(0., -3.), Point::new(2., -3.)),
